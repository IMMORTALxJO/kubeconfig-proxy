...
SHELL_FILES := install.sh e2e/run.sh e2e/run-upstream-kubectl-e2e.sh e2e/versions.sh e2e/versions_test.sh e2e/update-compatibility-profiles.sh e2e/update-compatibility-profiles_test.sh $(wildcard e2e/checks/*.sh)
...
e2e-profile-update-test:
	bash e2e/update-compatibility-profiles_test.sh
