...
| `e2e` | Real-cluster kind validation and upstream single-source `kubectl` compatibility runners; produces the latest HTML coverage report in `.codex/reports/coverage.html` | Production runtime code or Codex skill instructions |
